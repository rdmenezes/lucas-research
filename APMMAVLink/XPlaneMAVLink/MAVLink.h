...
public:
    ...
    __declspec( dllexport ) int sendMessages();
    ...
    __declspec( dllexport ) bool sendSystemStatus(uint8_t mode, uint8_t nav_mode, uint8_t status, uint16_t load, uint16_t vbat, uint16_t battery_remaining, uint16_t packet_drop);
    __declspec( dllexport ) bool getSystemStatus(uint8_t &mode, uint8_t &nav_mode, uint8_t &status, uint16_t &load, uint16_t &vbat, uint16_t &battery_remaining, uint16_t &packet_drop);
#else
